...
if (isset($_POST['submit'])) {
    ...
    $detail_product = $_POST['detail_product']; // แก้ไขจาก dtail_product เป็น detail_product
    $date_product = $_POST['date_product'];
    $vdo_detail_product = $_POST['vdo_detail_product']; // แก้ไขจาก dtail_vdo_product เป็น vdo_detail_product
    ...
    $sql = "INSERT INTO product (name_product, img_product, type_product, detail_product, img_detail_product, date_product, vdo_detail_product) 
            VALUES (:name_product, '', :type_product, :detail_product, :img_detail_product, :date_product, :vdo_detail_product)";
    ...
    if ($stmt->execute([
        ...
        $sql_update = "UPDATE product SET img_product = :img_product, img_detail_product = :img_detail_product WHERE id_product = :id_product";
