      ...
      <div class="banner_section layout_padding client_section ">
         ...
         <div class="container">
            <div id="banner_slider" class="carousel slide" data-ride="carousel">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="banner_taital_main">
                              ...
                              <div class="btn_main">
                                 <div class="about_bt"><a
                                       href="detailproduct1.html">About
                                       Us</a></div>
                              </div>
                           </div>
                        </div>
               ...
               <a class="carousel-control-prev" href="#banner_slider"
                  role="button" data-slide="prev">
                  <i class="fa fa-arrow-left"></i>
               </a>
               <a class="carousel-control-next" href="#banner_slider"
                  ...
                  <div class="container-fluid">
                     <div class="row">
                        <div class="col-lg-3 col-md-6">
                           ...
                           <div class="read_bt"><a
                                 href="detailproduct1.html">Read More</a></div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                           <div class="product_img"><img
                                 src="images/2.png"></div>
                        ...
                        <div class="location_text">
                           ...
                           <li>
                              ...
                              <i class="fa fa-envelope"></i><a
                                 class="padding_left_10"> eee</a>
                           </a>
                        </li>
                        <li>

                           <i class="fas fa-map-marker-alt"></i><span
                              class="padding_left_10">map</span>
